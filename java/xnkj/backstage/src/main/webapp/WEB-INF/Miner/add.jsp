...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="#">添加矿机</a></li>
		</ul>
				...
				<div class="span9">
					<table class="table table-bordered">
						<tr>
							...
							<td>
								<input type="text" style="width: 400px;" name="username" required value="" placeholder="请输入矿机名称"/>
								<span class="form-required">*</span>
							</td>
						</tr>
						<tr>
							<th>价格</th>
							<td><input type="text" name="price" value="" required style="width: 400px"></td>
						</tr>
						<tr>
							<th>日收益</th>
							<td><input type="text" name="profit" value="" required style="width: 400px"></td>
						</tr>
						<tr>
							<th>回本时间</th>
							<td><input type="text" name="returnTime" value="" required style="width: 400px">天</td>
						</tr>
						<tr>
							<th>月收益</th>
							<td><input type="text" name="monthlyIncome" value="" required style="width: 400px"></td>
						</tr>
						<tr>
							<th>推荐一代</th>
							<td>
								<input type="text" name="generation" value="" required style="width: 400px">
						...
						<tr>
							<th>推荐二代</th>
							<td>
								<input type="text" name="twoGeneration" value="" required style="width: 400px">
								<span class="form-required">(注：格式为0.06，表示为6%)</span>
							</td>
						</tr>
						<tr>
							<th>推荐无限代</th>
							<td>
								<input type="text" name="infiniteGeneration" value="" required style="width: 400px">
						...
						<tr>
							<th>收益说明</th>
							<td>
								<textarea  name="remark" cols="3" style="width: 400px;"></textarea>
							</td>
						</tr>
					</table>
				</div>
