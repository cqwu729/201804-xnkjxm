...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="#">编辑轮播</a></li>
		</ul>
				...
				<div class="span9">
					<table class="table table-bordered">
						<tr>
							<th>轮播名称</th>
							<td>
								<input type="text" style="width: 400px;" required name="username" value="${advertisement.username}" placeholder="请输入轮播名称"/>
								<input type="hidden" style="width: 400px;" required name="id" value="${advertisement.id}" placeholder="请输入轮播名称"/>
								<span class="form-required">*</span>
							</td>
						</tr>
						<tr>
							<th>跳转链接</th>
							<td><input type="text" name="url" required value="${advertisement.url}" style="width: 400px"></td>
						</tr>
					</table>
				</div>
				<div class="span3">
						...
						<tr>
							<td>
								<div style="text-align: center;">
									<input type="hidden" name="picture" id="thumb" value="${advertisement.picture}">
									<a href="javascript:void(0);" onclick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
										<c:if test="${not empty advertisement.picture}">
											<img src="${advertisement.picture}" id="thumb_preview" width="135" style="cursor: hand" />
										</c:if>
										<c:if test="${empty advertisement.picture}">
