...
(function () {
     ...
     */
	//window.UEDITOR_HOME_URL = "/BackStage/js/ueditor/"
	...
	var URL1 = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
   /**
    ...
    window.UEDITOR_CONFIG = {
		...
		//图片上传配置区
		//,imageUrl:URL1+"jsp/imageUp.jsp"             //图片上传提交地址
		//,imagePath:URL + "jsp/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        // 服务器统一请求接口路径
        , serverUrl: URL + "jsp/index"
